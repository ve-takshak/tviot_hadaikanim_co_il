...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', setting('site_name', 'Insurance'))</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="@yield('title', setting('site_name', 'Insurance'))" />
    <meta name="keywords" content="@yield('title', setting('site_name', 'Insurance'))" />
    <meta name="author" content="Bee1" />
    <!-- App favicon -->
    ...
    {{-- <link rel="stylesheet" href="{{ asset('assets/admin/css/app.min.css') }}"
        data-dark="{{ asset('assets/admin/css/app-dark.min.css') }}" id="app-style" type="text/css" /> --}}
         ...
         <link rel="stylesheet" href="{{ asset('assets/admin/css/app-rtl.min.css')}}"
        data-dark="{{ asset('assets/admin/css/app-dark.min.css') }}" id="app-style" type="text/css" />
    <link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/style.css') }}" type="text/css" />
    {{-- <link rel="stylesheet" href="https://themesbrand.com/skote/layouts/assets/css/app-rtl.min.css" type="text/css" /> --}}

    @stack('styles')
</head>

<body class="{{ setting('theme_layout') }}" data-sidebar="dark" data-bs-theme="{{ $dark_mode == true ? 'dark': 'light' }}">
