<x-admin.layout>
	<x-admin.breadcrumb
            ...
            :actions="[
                ['text' => 'Create Pages', 'icon' => 'fas fa-plus', 'url' => route('pages.create'), 'permission' => 'pages_create', 'class' => 'btn-success '],
                ['text' => 'All Pages', 'icon' => 'fas fa-list', 'url' => route('pages.index'), 'permission' => 'pages_access', 'class' => 'btn-dark '],
            ]"
		/>

    <form method="POST" action="{{ route('pages.update', [$page]) }}" class="card shadow-sm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
