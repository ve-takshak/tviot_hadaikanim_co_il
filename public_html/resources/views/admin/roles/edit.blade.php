<x-admin.layout>
	<x-admin.breadcrumb 
        ...
        :actions="[
            ...
            ['text' => 'New Roles', 'icon' => 'fas fa-plus', 'url' => route('roles.index'), 'permission' => 'roles_create', 'class' => 'btn-dark '],
        ]" />
	
    <div class="row">
        <div class="col-md-5">
            <form method="POST" action="{{ route('roles.update', [$role]) }}" class="card shadow-sm">
                @csrf
                @method('PUT')
