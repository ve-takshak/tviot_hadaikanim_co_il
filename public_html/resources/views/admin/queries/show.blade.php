<x-admin.layout>
	<x-admin.breadcrumb
        ...
        :actions="[
            ['text' => 'Queries', 'icon' => 'fas fa-list', 'permission' => 'queries_access', 'url' => route('queries.index'), 'class' => 'btn-info '],
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-footer">
                    ...
                    <form action="{{ route('queries.destroy', [$query]) }}" method="POST" class="d-inline-block">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger delete-alert  load-circle">
