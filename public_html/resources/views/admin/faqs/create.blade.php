<x-admin.layout>
	<x-admin.breadcrumb
        ...
        :actions="[
            ['text' => 'All FAQs', 'icon' => 'fas fa-list', 'url' => route('faqs.index'), 'permission' => 'faqs_access', 'class' => 'btn-dark '],
        ]" />

    <form method="POST" action="{{ route('faqs.store') }}" class="card shadow-sm">
        @csrf
