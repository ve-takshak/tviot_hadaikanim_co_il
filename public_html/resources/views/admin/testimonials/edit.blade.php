<x-admin.layout>
	<x-admin.breadcrumb 
			...
			:links="[
                ...
                ['text' => 'Testimonials', 'url' => route('testimonials.index')],
                ['text' => 'Edit']
			]"
            :actions="[
                ['text' => 'Testimonials', 'icon' => 'fas fa-plus', 'url' => route('testimonials.index'), 'permission' => 'testimonials_access', 'class' => 'btn-success  '],
                ['text' => 'Create Testimonials', 'icon' => 'fas fa-plus', 'url' => route('testimonials.create'), 'permission' => 'testimonials_create', 'class' => 'btn-dark  '],
            ]"
		/>

    <form method="POST" action="{{ route('testimonials.update', [$testimonial]) }}" class="card shadow-sm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
