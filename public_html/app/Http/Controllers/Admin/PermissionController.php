...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return to_route('permissions.index')->withSuccess('SUCCESS !! New Permission is successfully created');
    }
    ...
    public function update(Request $request, Permission $permission)
    {
        ...
        return to_route('permissions.index')->withSuccess('SUCCESS !! New Permission is successfully updated');
    }
    ...
    public function destroy(Permission $permission)
    {
        ...
        $permission->delete();
        return to_route('permissions.index')->withSuccess('SUCCESS !! Permission is successfully deleted');
    }
    ...
    public function rolePermissionsUpdate(Request $request, Role $role)
    {
        ...
        return to_route('permissions.index')->withSuccess('SUCCESS !! Permissions are successfully updated');
    }
}
