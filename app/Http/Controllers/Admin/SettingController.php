...
class SettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('settings.index')->withSuccess('SUCCESS !! Setting has been updated.');
    }
    ...
    public function destroy(Setting $setting)
    {
        ...
        $setting->delete();
        cache()->forget('settings');
        return redirect()->route('settings.index')->withSuccess('SUCCESS !! Setting has been deleted.');
    }
}
